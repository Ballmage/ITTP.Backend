...
using ITTP.WebApi.Request;
using ITTP.WebApi.Validate;
...
namespace ITTP.WebApi.Controllers
{
    [Route("api/[controller]/[action]")]
    [ApiController]
    public class UsersController : ControllerBase
    {
        private readonly ITTPDbContext _context;

        public UsersController(ITTPDbContext context) =>
            _context = context;
